...
You can create new talks by adding new Markdown files in the [\talks](talks/) directory. The easiest way to do this is to copy an existing talks and modify it.
